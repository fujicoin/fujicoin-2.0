...
Finally, three new headers and source files will have to be added to FujiCoin-Qt.pro.
...
----------------------
bitcoin.cpp is the entry point into FujiCoin-Qt, and as such, will require some minor modifications to provide hooks for
